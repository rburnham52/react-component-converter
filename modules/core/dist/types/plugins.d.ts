...
export interface ConverterPlugin {
     ...
     */
    postParse?: (component: MitosisComponent, context: PluginContext) => MitosisComponent | Promise<MitosisComponent>;
    /**
     * Pre-generate hook: Runs before calling Mitosis generators
     * Use this to add metadata or modify component before generation
     */
    preGenerate?: (component: MitosisComponent, context: PluginContext) => MitosisComponent | Promise<MitosisComponent>;
    /**
     * Post-generate hook: Runs after Mitosis generators
     * Use this to transform the generated code (e.g., Svelte 5 runes)
     */
    postGenerate?: (code: string, component: MitosisComponent, context: PluginContext) => string | Promise<string>;
}
/**
