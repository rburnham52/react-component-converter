 ...
 */
export function jsxToMitosisNodes(jsxNode) {
    const nodes = [];
 ...
 */
function convertJsxSelfClosingElement(element) {
 ...
 */
function convertJsxFragment(fragment) {
    const children = [];
 ...
 */
function convertJsxExpression(expr) {
 ...
 */
function createMitosisNode(name, properties, bindings, children) {
    return {
        '@type': '@builder.io/mitosis/node',
        name,
        meta: {},
 ...
 */
export function extractJsxFromComponent(componentCode, sourceFile) {
 ...
 */
export function extractJsxForNamedComponent(sourceFile, componentName) {
 ...
 */
function extractJsxFromNode(node) {
 ...
 */
function extractJsxFromReturnStatements(node) {
...
//# sourceMappingURL=jsx-to-mitosis.js.map