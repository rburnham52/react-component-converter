 ...
 * ```
 */
export function analyzeForwardRef(sourceFile: SourceFile): ForwardRefConfig | undefined {
 ...
 */
export function hasForwardRef(sourceFile: SourceFile): boolean {
 ...
 */
export function getForwardRefComponentName(sourceFile: SourceFile): string | undefined {
  const forwardRefCalls = sourceFile.getDescendantsOfKind(SyntaxKind.CallExpression)
    .filter(call => {
